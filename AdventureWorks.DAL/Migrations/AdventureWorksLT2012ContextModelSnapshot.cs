...
{
    [DbContext(typeof(AdventureWorksLT2012Context))]
    partial class AdventureWorksLT2012ContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AdventureWorks.Core.Entities.Address", b =>
                {
                    ...
                    b
                        .HasComment("Street address information for customers.");
                });

            modelBuilder.Entity("AdventureWorks.Core.Entities.BuildVersion", b =>
                {
                    ...
                    b
                        .HasComment("Current version number of the AdventureWorksLT 2008 sample database. ");
                });

            modelBuilder.Entity("AdventureWorks.Core.Entities.Customer", b =>
                {
                    ...
                    b
                        .HasComment("Customer information.");
                });

            modelBuilder.Entity("AdventureWorks.Core.Entities.CustomerAddress", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int")
                        .HasColumnName("CustomerID")
                    ...
                    b
                        .HasComment("Cross-reference table mapping customers to their address(es).");
                });

            modelBuilder.Entity("AdventureWorks.Core.Entities.ErrorLog", b =>
                {
            ...
            modelBuilder.Entity("AdventureWorks.Core.Entities.Product", b =>
                {
            ...
            modelBuilder.Entity("AdventureWorks.Core.Entities.ProductCategory", b =>
                {
                    b.Property<int>("ProductCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AdventureWorks.Core.Entities.ProductDescription", b =>
                {
            ...
            modelBuilder.Entity("AdventureWorks.Core.Entities.ProductModel", b =>
                {
                    b.Property<int>("ProductModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AdventureWorks.Core.Entities.ProductModelProductDescription", b =>
                {
                    b.Property<int>("ProductModelId")
                        .HasColumnType("int")
                        .HasColumnName("ProductModelID")
            ...
            modelBuilder.Entity("AdventureWorks.Core.Entities.SalesOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("AdventureWorks.Core.Entities.SalesOrderHeader", b =>
                {
                    b.Property<int>("SalesOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AdventureWorks.Core.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AdventureWorks.Core.Entities.VGetAllCategory", b =>
                {
            ...
            modelBuilder.Entity("AdventureWorks.Core.Entities.VProductAndDescription", b =>
                {
                    b.Property<string>("Culture")
                        .IsRequired()
                        .HasMaxLength(6)
            ...
            modelBuilder.Entity("AdventureWorks.Core.Entities.VProductModelCatalogDescription", b =>
                {
                    ...
                    b
                        .HasComment("Displays the content from each element in the xml column CatalogDescription for each product in the Sales.ProductModel table that has catalog data.");
                });

            modelBuilder.Entity("AdventureWorks.Core.Entities.CustomerAddress", b =>
                {
                    b.HasOne("AdventureWorks.Core.Entities.Address", "Address")
                        .WithMany("CustomerAddresses")
                        .HasForeignKey("AddressId")
                        .IsRequired();

                    b.HasOne("AdventureWorks.Core.Entities.Customer", "Customer")
                        .WithMany("CustomerAddresses")
            ...
            modelBuilder.Entity("AdventureWorks.Core.Entities.Product", b =>
                {
                    b.HasOne("AdventureWorks.Core.Entities.ProductCategory", "ProductCategory")
                        .WithMany("Products")
                        .HasForeignKey("ProductCategoryId");

                    b.HasOne("AdventureWorks.Core.Entities.ProductModel", "ProductModel")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("AdventureWorks.Core.Entities.ProductCategory", b =>
                {
                    b.HasOne("AdventureWorks.Core.Entities.ProductCategory", "ParentProductCategory")
            ...
            modelBuilder.Entity("AdventureWorks.Core.Entities.ProductModelProductDescription", b =>
                {
                    b.HasOne("AdventureWorks.Core.Entities.ProductDescription", "ProductDescription")
            ...
            modelBuilder.Entity("AdventureWorks.Core.Entities.SalesOrderDetail", b =>
                {
                    b.HasOne("AdventureWorks.Core.Entities.Product", "Product")
                        .WithMany("SalesOrderDetails")
                        .HasForeignKey("ProductId")
                        .IsRequired();

                    b.HasOne("AdventureWorks.Core.Entities.SalesOrderHeader", "SalesOrder")
                        .WithMany("SalesOrderDetails")
            ...
            modelBuilder.Entity("AdventureWorks.Core.Entities.SalesOrderHeader", b =>
                {
                    b.HasOne("AdventureWorks.Core.Entities.Address", "BillToAddress")
                    ...
                    b.HasOne("AdventureWorks.Core.Entities.Address", "ShipToAddress")
